...
import com.neu.notasreactivex.reactive.RXJava.atualizarNota
...
class EditPresenterImpl(val jsonNota: String?, val editView: EditView) : EditPresenter {
    ...
    private fun obterNota() : Nota = if (jsonNota.isNullOrEmpty()) criarNota() else notaFromJson(jsonNota)
    ...
    override fun setarDados() {
        nota.let {
            ...
            if(nota.isWithoutId()) editView.setTextTerminarBtn("Criar") else  editView.setTextTerminarBtn("Alterar")
        }
    }
